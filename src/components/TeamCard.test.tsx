...
describe("TeamCard Component", () => {
  ...
  it("shows 'Done' status when all agents are done", () => {
    const teamWithDoneAgents: Team = {
      ...mockTeam,
      agents: [
        { id: "a1", team_id: "1", role: "A1", status: "done", summary: "done", tokensUsed: 0, input_schema: [], output_schema: [], logs: [] }
      ]
    };
  ...
  it("shows 'Action Needed' when an agent is waiting approval", () => {
    const teamWithActionNeeded: Team = {
      ...
      agents: [
        { id: "a1", team_id: "1", role: "A1", status: "done", summary: "done", tokensUsed: 0, input_schema: [], output_schema: [], logs: [] },
        { id: "a2", team_id: "1", role: "A2", status: "waiting_approval", summary: "wait", tokensUsed: 0, input_schema: [], output_schema: [], logs: [] }
      ]
    };
